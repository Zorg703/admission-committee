...
//import by.mordas.project.service.AdminLogic;
...
//                errorMap=validator.checkSpecialtyData(parameters);
//                if (errorMap.isEmpty()){
//                Speciality speciality=findSpecialityById(parameters.get(ParamConstant.SPECIALITY_ID));
//                if(speciality!=null) {
...
//            Speciality speciality=findSpecialityById(specialityId);
