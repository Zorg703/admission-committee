...
public enum CommandType {
    ...
    GO_TO_CHOOSE_FACULTY_TO_RESULT(ClientType.ADMIN),
    GO_TO_CHANGE_SPECIALITY_REGISTER_DATE_PAGE(ClientType.ADMIN),
    NEXT_FIND_REGISTER_USERS_PAGE(ClientType.ADMIN),
    NEXT_FIND_SPECIALITIES_PAGE(ClientType.ADMIN),
